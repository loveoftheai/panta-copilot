...
*Written by the agent pipeline from a live Panta API pull at 2026-09-24T21:14:12.994Z · catalog 50 unique markets, 40 detailed.*
...
- `primaryorderquote` rejects pre-open markets (INVALID_MARKET_PARAMS) — the honest answer to "can I buy YES right now" is *not until the curve opens*.
